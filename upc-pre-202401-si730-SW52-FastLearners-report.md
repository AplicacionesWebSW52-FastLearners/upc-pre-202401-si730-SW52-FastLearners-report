...
| HU07 | Contactar con equipo de soporte | Como usuario nuevo, quiero poder contactar fácilmente con el equipo de soporte desde la página de inicio en caso de tener algún problema o pregunta sobre la plataforma. | - Escenario 1: Dado que soy un usuario registrado, cuando hay nuevos cursos disponibles, entonces recibo una notificación por correo electrónico o dentro de la plataforma, y puedo ver un resumen del nuevo contenido.<br />- Escenario 2: Dado que soy un usuario registrado, cuando reviso las notificaciones, entonces puedo filtrar las notificaciones por categoría y nivel de dificultad, y marcar como leídas aquellas que no me interesan.| - |
