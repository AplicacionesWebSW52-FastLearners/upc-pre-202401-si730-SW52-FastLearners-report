...
| - | - | - |
| Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software. | Carlos Ochoa: <br> *TB1:* Me enfoqué en el Startup Profile, la misión, la visión, los antecedentes y problemática de manera objetiva. <br> *TP:* Me enfoqué en realizar las mejoras respectivas en el frontend Web Application, además de tratar de volverla responsiva. Aporté con la mejora del informe. <br> *TB2:* Ayudé con el desarrollo inicial del Web Services para poder tener un backend funcional. Ayudé en mejorar y ampliar secciones en el Frontend Web Application. <br> *TF:* Me encargué de realizar la mejora continua verificando que se estaban cumpliendo con todos los puntos que se requerían en la entrega final. Aporté en el desarrollo de las últimas mejoras del Frontend Web Application. <br> <br> Jorge Orrego: <br> *TB1:* Me encargué de realizar el diseño de la Landing Page y de la plataforma web. <br> *TP:* Me encargué de colaborar en el desarrollo del frontend y del reporte en equipo. <br> *TB2:* Me encargué de colaborar en el desarrollo del reporte en equipo. <br> *TF:* Me encargué de colaborar en el desarrollo del backend y del reporte en equipo. <br> <br> Alejandro Pachas: <br> *TB1:* Redacté los User Stories y el Product backlog.<br>*TP:* Corregí los User Stories y Product backlog a corde al feedback proporcionado, también identifiqué las Tablas MySQL que serán desarrolladas en el Backend de la aplicación.<br>*TB2:* Me guié del diagrama de clases proporcionado por mis compañeros para estructuración del código Backend. <br>*TF:* Desarrollé el código Backend guíandome del Product Backlog previamente realizado<br> <br> Santiago Olivera: <br> *TB1:* Colaboré en la definición de los requisitos y en la creación de wireframes para la plataforma web. <br> *TP:* Desarrollé módulos específicos del backend y colaboré en la integración del frontend con el backend. <br> *TB2:* Me enfoqué en mejorar el rendimiento y la seguridad de la aplicación web. <br> *TF:* Ayudé en la documentación final del proyecto y realicé pruebas de usuario. <br> <br> Marco Mendez: <br> *TB1:* Participé en la creación del diagrama de arquitectura del sistema y en la planificación inicial del proyecto. <br> *TP:* Contribuí al desarrollo del frontend, enfocándome en la experiencia de usuario y en la accesibilidad. <br> *TB2:* Trabajé en la integración de APIs externas y en la optimización del frontend. <br> *TF:* Coordiné la presentación final del proyecto y preparé material de apoyo visual. <br> | Colaboración Eficaz: Se mostró un alto nivel de colaboración entre los integrantes del equipo, evidenciado por el registro detallado de versiones y las contribuciones individuales de cada miembro, lo que sugiere una comunicación efectiva y una distribución clara de responsabilidades. <br> <br> Objetividad en la Evaluación: La práctica de actualizar el informe en distintas fases del proyecto (TB1, TP, TB2, TF) permitió evaluar objetivamente el progreso y las contribuciones, asegurando que cada etapa del proyecto cumpla con los objetivos planteados y mantenga un enfoque en la calidad del producto final. <br> <br> Eficiencia en la Gestión de Proyectos: El uso de un sistema de control de versiones y el seguimiento de commits en el repositorio evidenciaron una gestión eficiente del proyecto, facilitando la coordinación de tareas y la integración de soluciones de manera ordenada y documentada. |
| Conoce al menos un sector empresarial o dominio de aplicación de soluciones de software. | Carlos Ochoa: <br> *TB1:* Desarrollé el apartado del Lean UX Process. <br> *TP:* Me enfoqué en el desarrollo e implementación del Frontend Web Application, así como de la fake API en Json Server. <br> *TB2:* Apoyé en el desarrollo de las Web Services por el lado del backend al configurar los endpoints iniciales. <br> *TF:* Me enfoqué en aplicar los últimos cambios de la mejora continua para poder tener todo el informe lo más completo posible. <br> <br> Jorge Orrego: <br> *TB1:* Me encargué de realizar las guías para el diseño del sitio web siguiendo las necesidades de los sectores objetivos. <br> *TP:* Me encargué del despliegue de la aplicación. <br> *TB2:* Me encargué de formular las preguntas para las entrevistas de validación. <br> *TF:* Me encargué de revisar las entrevistas y de analizarlas para sacar conclusiones. <br> <br> Alejandro Pachas: <br> *TB1:* Realicé el Impact Map de la aplicación.<br> *TP:* Contribuí en el desarrollo web de la aplicación, así como así como el desarrollo responsive de la Landing Page.<br> *TB2:* Me enfoqué exclusivamente en el desarrollo de los Web Services, siguendo el patrón Domain-Driven Design (DDD). Desplegué la base de datos en Azure y la conecté al código de la aplicación  <br>*TF:* Utilicé Docker para el despliegue de los Web-Service a Azure. También me encargué de la encriptación de contraseñas, almacenamiento de datos y creación de tablas en MySQL.<br> <br> Santiago Olivera: <br> *TB1:* Participé en la investigación de mercado para identificar las necesidades del sector educativo. <br> *TP:* Ayudé en la creación de contenido educativo interactivo para la plataforma. <br> *TB2:* Trabajé en la integración de funcionalidades específicas del sector educativo, como la gestión de cursos y la evaluación de estudiantes. <br> *TF:* Contribuí en la validación de la aplicación con usuarios finales del sector educativo. <br> <br> Marco Mendez: <br> *TB1:* Realicé un análisis comparativo de soluciones de software existentes en el sector educativo. <br> *TP:* Colaboré en el diseño de la interfaz de usuario enfocada en las necesidades de los docentes y estudiantes. <br> *TB2:* Desarrollé herramientas de análisis y reporte para la plataforma educativa. <br> *TF:* Participé en la implementación de mejoras basadas en feedback de pruebas con usuarios finales. <br> | Aplicación en el Sector Educativo: La elección de la startup "FastLearners" evidenció que nuestro equipo tiene conocimiento en el desarrollo de soluciones de software orientadas al sector educativo, un dominio que requiere funcionalidades específicas y una comprensión profunda de las necesidades de los usuarios finales. <br> <br> Desarrollo de Soluciones Personalizadas: El equipo demostró poseer habilidades para crear soluciones de software personalizadas que pueden adaptarse a los requisitos de diversos sectores empresariales, demostrando versatilidad y competencia técnica. <br> <br> Implementación de Tecnologías Modernas: El uso de tecnologías y metodologías modernas en el desarrollo del proyecto evidenció que nuestro equipo está al tanto de las tendencias actuales en el sector de software, permitiendo la creación de aplicaciones que cumplen con los estándares de la industria y pueden aplicarse eficazmente en diferentes dominios empresariales. |
...
|---------------------|--------|-------------|--------------------------|---------------------------|
| HU01 | Ver página de inicio atractiva | Como usuario nuevo, quiero ver una página de inicio atractiva con información clara sobre las funcionalidades de la plataforma para entender rápidamente de qué se trata. | - Escenario 1: Dado que soy un usuario nuevo, cuando accedo a la página de inicio, entonces puedo entender las características principales de la plataforma, y la información clave está presentada de manera clara y concisa.<br />- Escenario 2: Dado que soy un usuario nuevo, cuando accedo a la página de inicio, entonces puedo navegar fácilmente a través de las secciones, y las funcionalidades están organizadas de manera intuitiva. | - |
| HU02 | Registrarme rápidamente | Como usuario nuevo, quiero poder registrarme rápidamente en la plataforma con mi correo electrónico o a través de redes sociales para comenzar a usarla de inmediato. |- Escenario 1: Dado que soy un usuario nuevo, cuando inicio el proceso de registro, entonces puedo completarlo en no más de 5 pasos, y tengo la opción de registrarme utilizando mi correo electrónico o mis cuentas de redes sociales.<br />- Escenario 2: Dado que soy un usuario nuevo, cuando me registro con mis redes sociales, entonces el sistema recupera automáticamente mis datos básicos, y el proceso es aún más rápido.| - |
| HU03 | Recibir correo de bienvenida | Como usuario nuevo, quiero recibir un correo electrónico de bienvenida después de registrarme en la plataforma para confirmar mi registro y proporcionarme información adicional sobre cómo empezar a usarla. |- Escenario 1: Dado que soy un usuario nuevo, cuando me registro en la plataforma, entonces recibo un correo de bienvenida dentro de los 5 minutos posteriores al registro, y este correo contiene información útil sobre cómo empezar a usar la plataforma.<br />- Escenario 2: Dado que soy un usuario nuevo, cuando recibo el correo de bienvenida, entonces encuentro enlaces directos a tutoriales y recursos de ayuda, y puedo empezar a explorar la plataforma de inmediato. | - |
| HU04 | Buscar cursos y recursos | Como usuario nuevo, quiero poder buscar cursos y recursos de aprendizaje fácilmente desde la página de inicio para encontrar rápidamente lo que necesito. |- Escenario 1: Dado que soy un usuario nuevo, cuando accedo a la página de inicio, entonces veo una barra de búsqueda claramente visible, y los resultados de búsqueda son relevantes y están ordenados por popularidad. <br />- Escenario 2: Dado que soy un usuario nuevo, cuando utilizo la barra de búsqueda, entonces puedo filtrar los resultados por categoría, nivel de dificultad y popularidad, y los resultados se actualizan en tiempo real. | - |
| HU05 | Ver detalles del curso | Como usuario registrado, quiero poder ver los detalles de un curso específico para decidir si quiero inscribirme. | - Escenario 1: Dado que soy un usuario registrado, cuando selecciono un curso, entonces puedo ver información detallada sobre el contenido del curso, la duración, el nivel de dificultad y las opiniones de otros usuarios. <br />- Escenario 2: Dado que soy un usuario registrado, cuando veo los detalles del curso, entonces tengo la opción de inscribirme directamente desde esa página y ver recomendaciones de cursos similares.| - |
| HU06 | Acceder a sección de preguntas frecuentes | Como usuario nuevo, quiero tener acceso a una sección de preguntas frecuentes (FAQ) en la página de inicio para poder resolver rápidamente mis dudas sobre el funcionamiento de la plataforma. |- Escenario 1: Dado que soy un usuario nuevo, cuando accedo a la página de inicio de la plataforma, entonces puedo ver un enlace claro y visible a la sección de preguntas frecuentes (FAQ). <br />- Escenario 2: Dado que soy un usuario nuevo, cuando hago clic en el enlace a la sección de preguntas frecuentes (FAQ), entonces puedo acceder a una lista organizada de preguntas y respuestas comunes sobre el funcionamiento de la plataforma. | - |
| HU07 | Contactar con equipo de soporte técnico | Como usuario registrado, quiero poder contactar al soporte técnico fácilmente cuando tenga problemas para recibir ayuda rápida y eficiente. | - Escenario 1: Dado que soy un usuario registrado, cuando necesito ayuda, entonces puedo acceder a una sección de soporte técnico desde la plataforma y enviar mis consultas.<br />- Escenario 2: Dado que soy un usuario registrado, cuando envío una consulta al soporte técnico, entonces recibo una respuesta dentro de 24 horas y puedo hacer seguimiento al estado de mi solicitud.| - |
| HU08 | Participar en foros de discusión | Como usuario registrado, quiero participar en foros de discusión relacionados con los cursos para interactuar con otros estudiantes y obtener ayuda. | - Escenario 1: Dado que soy un usuario registrado, cuando accedo a un foro de discusión, entonces puedo ver todos los hilos de conversación y publicar mis propias preguntas o respuestas.<br />- Escenario 2: Dado que soy un usuario registrado, cuando participo en un foro, entonces puedo recibir notificaciones de respuestas a mis publicaciones y valorar las contribuciones de otros usuarios.| - |
| HU09 | Completar evaluaciones de curso | Como usuario registrado, quiero completar evaluaciones al final de cada curso para medir mi aprendizaje y obtener un certificado. | - Escenario 1: Dado que soy un usuario registrado, cuando finalizo un curso, entonces puedo acceder a una evaluación final, y la evaluación cubre todos los temas del curso. <br />- Escenario 2: Dado que soy un usuario registrado, cuando completo la evaluación, entonces recibo un certificado digital si apruebo, y puedo descargarlo o compartirlo en redes sociales.| - |
...
| HU28 | Participar en eventos y conferencias virtuales | Como usuario de la plataforma, quiero poder participar en eventos y conferencias virtuales sobre programación web para ampliar mis conocimientos y conectar con otros profesionales del sector. | - Escenario 1: Dado que soy un usuario de la plataforma, cuando accedo a la sección de eventos y conferencias virtuales, entonces veo una lista actualizada de eventos próximos, incluyendo detalles como la fecha, hora y tema del evento.<br />- Escenario 2: Dado que soy un usuario de la plataforma, cuando me inscribo en un evento virtual, entonces recibo una confirmación por correo electrónico con un enlace de acceso al evento y recordatorios antes de que este comience.| - |
...
| 5 | HU05 | Ver detalles del curso	 | Como usuario registrado, quiero poder ver los detalles de un curso específico para decidir si quiero inscribirme.	| 2 |
...
| 7 | HU07 | Contactar con equipo de soporte técnico | Como usuario registrado, quiero poder contactar al soporte técnico fácilmente cuando tenga problemas para recibir ayuda rápida y eficiente.	| 3 |
| 8 | HU08 | Participar en foros de discusión | Como usuario registrado, quiero participar en foros de discusión relacionados con los cursos para interactuar con otros estudiantes y obtener ayuda.	| 5 |
| 9 | HU09 | Completar evaluaciones de curso | Como usuario registrado, quiero completar evaluaciones al final de cada curso para medir mi aprendizaje y obtener un certificado.	| 3 |
...
| 12 | HU12 | Usar la aplicación móvil | Como usuario registrado, quiero usar la aplicación móvil de la plataforma para acceder a los cursos y recursos desde cualquier lugar.	| 2 |
| 13 | HU13 | Acceder a contenido premium | Como usuario premium, quiero acceder a contenido exclusivo y de alta calidad para mejorar mis habilidades de manera más avanzada. | 5 |
...
|                     |                                         | TK22 | UI de categorías y pruebas      | Diseñar UI de categorías y realizar pruebas                | 6                 | Santiago     | To-Do                                |
...
| HU26                | Acceder a material en varios idiomas    | TK58 | Traducción y pruebas            | Traducir materiales y realizar pruebas                     | 8                | Santiago       | To-Do                                |
|                     |                                         | TK59 | UI para selección de idioma     | Diseñar UI para selección de idioma                        | 7                  | Santiago       | To-Do                                |
...
|                     |                                         | TK63 | Lectura fácil y pruebas         | Desarrollar lectura fácil y realizar pruebas de accesibilidad | 11                 | Santiago       | To-Do                                |
...
| Alumno | Actividad |
|--------|-----------|
| Olivera Mickelle, Santiago | Reporte, Desarrollo del Backend  |
| Orrego Noriega, Jorge David | Reporte, Desarrollo del Backend |
