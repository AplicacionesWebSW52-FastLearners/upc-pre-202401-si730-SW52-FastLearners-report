...
|---------------------|--------|-------------|--------------------------|---------------------------|
| HU01 | Ver página de inicio atractiva | Como usuario nuevo, quiero ver una página de inicio atractiva con información clara sobre las funcionalidades de la plataforma para entender rápidamente de qué se trata. | Escenario: El usuario visita la página de inicio de la aplicación => Dado que el usuario quiere visitar la página principal de nuestra plataforma, cuando este vea la interfaz intuitiva y fácile de navegar, entonces podrá navegar fácilmente por la plataforma. | - |
| HU02 | Registrarme rápidamente | Como usuario nuevo, quiero poder registrarme rápidamente en la plataforma con mi correo electrónico o a través de redes sociales para comenzar a usarla de inmediato. | Escenario: El usuario quiere registrarse en la plataforma => Dado que el usuario quiere registrarse en la plataforma, y ya está ubicado en el formulario de registro de usuario al seleccionar la opción de "Crear Cuenta", cuando este ingrese todos sus datos pertinentes para la creación de la cuenta (nombres y apellidos, correo electrónico, etc.), entonces podrá crear su cuenta sin problema alguno. | - |
| HU03 | Recibir correo de bienvenida | Como usuario nuevo, quiero recibir un correo electrónico de bienvenida después de registrarme en la plataforma para confirmar mi registro y proporcionarme información adicional sobre cómo empezar a usarla. |Escenario: El usuario recibe un correo de confirmación del registro de su cuenta => Dado que el usuario ya completó el formulario de creación de cuenta, cuando el sistema ya haya registrado la creación de su cuenta, entonces el usuario recibirá un correo electrónico validando la creación de su cuenta.  | - |
| HU04 | Buscar cursos y recursos | Como usuario nuevo, quiero poder buscar cursos y recursos de aprendizaje fácilmente desde la página de inicio para encontrar rápidamente lo que necesito. | Escenario: El usuario quiere buscar contenido de aprendizaje en la página principal => Dado que el usuario se encuentra en la página principal de la plataforma, cuando este se dirija al menú de opciones en la parte superior de la interfaz, entonces podrá elegir el tipo de contenido que desea buscar. | - |
